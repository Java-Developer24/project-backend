...
export const userBlockDetails = async ({ email, totalRecharge, usedBalance,toBeBalance,currentBalance,fraudAmount,reason,ipDetails }) => {
  try {
    ...
    const response = await fetch(
      `https://api.telegram.org/bot6868379504:AAFCrDg-8TrIRkTs2xu4y2KWrDBjpBI05tc/sendMessage?chat_id=6769991787&text=${encodedResult}`
